...
if ($formtype == 'q_edit') { // ...in edit mode
	...
	//STW_EDIT
	if($countfortitle){
		$stw_meta_title_sq = $qa_content['title'] . ' - ' . stw_num_word_skl($countfortitle, array(qa_lang_html('question/stw_x_answers_title_1'), qa_lang_html('question/stw_x_answers_title_2'), qa_lang_html('question/stw_x_answers_title_3')), true);
		$stw_meta_title_sq = strip_tags($stw_meta_title_sq);
			
		$qa_content['seo_meta_title'] = $stw_meta_title_sq . ' | ' . qa_html(qa_opt('site_title'));
	}
...
if ($microdata) {
	...
	if($countfortitle){
		$qa_content['head_lines'][] = '<meta itemprop="name" content="' . qa_html($stw_meta_title_sq) . '">';
	} else {
...
if ($question['basetype'] == 'Q') {
	...
	$qa_content['a_list']['title'] = stw_num_word_skl($countfortitle, array(qa_lang_html('question/stw_x_answers_title_1'), qa_lang_html('question/stw_x_answers_title_2'), qa_lang_html('question/stw_x_answers_title_3')));
