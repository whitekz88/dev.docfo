		...
		if (qa_is_logged_in()) {
			...
			$this->output('<ul class="qa-nav-user-list">');
				...
				if($this->template == 'user' && qa_request_part(1) == $username){
					$this->output('<a href="'.qa_path_html( "user/id".qa_get_logged_in_user_field('userid') ).'" class="qa-nav-user-link qa-nav-user-selected">'. qa_lang_html_sub('main/x_points', $pointshtml) .'</a>');
				}else{
					$this->output('<a href="'.qa_path_html( "user/id".qa_get_logged_in_user_field('userid') ).'" class="qa-nav-user-link">'. qa_lang_html_sub('main/x_points', $pointshtml) .'</a>');
				}
				$this->output('</li>');
